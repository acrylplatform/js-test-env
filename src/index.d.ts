...
/// NODE INTERACTION
    ...
    /**
     * Retrieve full information about acryl account balance. Effective, generating etc
     * By default uses current environment address and node
     */
    ...
    /**
     * Sends transaction to acryl node
     * By default uses current environment address and node
     */
...
// UTILITY
    ...
    export interface ISetupAccountsOptions {
        ...
        nonce?: string,
        /**
         * Seed phrase for account, from which acryl will be transferred to generated accounts.
    ...
    /**
     * Generates test accounts with balances. Sends acryl to generated accounts from master seed. Saves account seeds `accounts`
    ...
    /**
     * Acryl-crypto library https://www.npmjs.com/package/@acryl/acryl-crypto
     * Available in global scope:
     * ```js
     * const addressBytes = crypto.base58Decode('3N77yhDrPTdLFjzNPZcBQPZLDg11EHAB7xF')
     * ```
     */
    export module acrylCrypto {
